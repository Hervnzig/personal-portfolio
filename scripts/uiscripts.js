...
// ======= displaying comments ==========
const commentFormContainer = document.querySelector("#commentFormContainer");
const showFormBtn = document.querySelector("#displayCommentBtn");
const displayCommentForm = document.querySelector("#writeCommentForm");

showFormBtn.onclick = function () {
  if (commentFormContainer.className === "hide") {
    commentFormContainer.className = "show";
  } else {
    commentFormContainer.className = "hide";
    displayCommentForm.reset();
  }
};
